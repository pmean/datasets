---
title: "Cigarettes upload to SQLite"
author: "Steve Simon"
...
This file was created on 2020-07-19 and last modified on `r Sys.Date()`.
...
db <- dbConnect(SQLite(), dbname=sqlite_name)
dbListTables(db)
dbGetQuery(conn=db, "select * from cigarettes")
dbDisconnect(conn=db)
```